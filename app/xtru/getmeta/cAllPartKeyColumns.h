...
/**
 * @class cAllPartKeyColumns
 * @brief
 * provides the subset data of ALL_PART_KEY_COLUMNS.
 *
 * @details
 ...
 * @code
    ...
    ...
    ps::app::xtru::getmeta::cAllPartKeyColumns oObj;
...
private:
    ...
    typedef void (cAllPartKeyColumns::tAttributes::*tOnRepeatAction)(
        std::ostream&
        , const size_t&
        , cAllPartKeyColumns&
    ) const;
    /// @copydoc cAllSequences::tOneTimeAction
    typedef void (cAllPartKeyColumns::*tOneTimeAction)(
        std::ostream&
        , const tAttributes&
    ) const;
    ...
    /// @brief A SQL-select to select ALL_PART_KEY_COLUMNS
    static const char szAllPartKeyColumns[];
public:
    /**
     * @brief
     */
    cAllPartKeyColumns();
    virtual ~cAllPartKeyColumns();
    /**
     * @brief
     * @param [in,out] oSvc
