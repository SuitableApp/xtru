...
/**
 * @class cAllColComments
 * @brief
 * provides the subset data of ALL_COL_COMMENTS
 *
 * @details
 ...
 * @code
    ...
    ...
    ps::app::xtru::getmeta::cAllColComments oObj;
...
private:
    ...
    typedef void (cAllColComments::tAttributes::*tOnRepeatAction)(
        std::ostream&
        , const size_t&
        , cAllColComments&
    ) const;
    /// @copydoc cAllSequences::tOneTimeAction
    typedef void (cAllColComments::*tOneTimeAction)(
        std::ostream&
        , const tAttributes&
    ) const;
    ...
    /// @brief A SQL-select to select ALL_COL_COMMENTS
    static const char szAllColComments[];
public:
   /**
     * @brief
     */
    cAllColComments();
    virtual ~cAllColComments();
    /**
     * @brief
     * @param [in,out] oSvc
